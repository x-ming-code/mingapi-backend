...
import static com.ming.springbootinit.constant.UserConstant.USER_LOGIN_STATE;
...
import com.ming.springbootinit.utils.SqlUtils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            String secretKey =DigestUtil.md5Hex(SALT + userAccount + RandomUtil.randomNumbers(9));
            // 3. 插入数据
            User user = new User();
